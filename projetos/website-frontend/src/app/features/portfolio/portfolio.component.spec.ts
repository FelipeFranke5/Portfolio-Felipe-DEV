...
describe('PortfolioComponent', () => {
  ...
  it('should render the certificates section below the projects grid', () => {
    const certificatesElement = fixture.nativeElement.querySelector('app-certificates');

    expect(certificatesElement).not.toBeNull();
    expect(certificatesElement.querySelectorAll('.certificate-card').length).toBeGreaterThan(0);
  });
});
